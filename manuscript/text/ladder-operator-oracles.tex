...
To apply the creation operator, the occupancy is increased the occupancy by $1$ and then apply the rotations, whereas for the annihilation operator, we wish to apply the rotations and then decrease the occupancy by $1$.
