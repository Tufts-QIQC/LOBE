...
In this section, we demonstrate the use of LOBE to block-encode Hamiltonians derived from quantum field theories: Yukawa theory and $\phi^4$ theory \ws{citations}. These models are \ws{insert-blah here @gus @kamil}.
