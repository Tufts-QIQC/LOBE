...
In this subsection, we merely restate an observation by Gilyén et. al \cite{gilyen2019quantum} when the aim is to construct a block-encoding of a product of operators:
\begin{theorem}
    \label{th:product}
...
To paraphrase, a block-encoding of a product of operators can be constructed by the product of the block-encodings of the individual operators. \ws{Interesting connection to Trotter...}
