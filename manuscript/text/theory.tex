...
\end{equation}
where $L$ is the total number of terms and $\alpha_l$ are positive, real-valued \gus{I \textit{think} we can have complex coefficients here, no?} coefficients associated with the terms $T_l$.
