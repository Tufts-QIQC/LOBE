...
\begin{equation}
    ...
    H^* = \sum_{l=0}^{L-1} \alpha_l^* \Tilde{T}_l
\end{equation}
where $H^*$ is the rescaled Hamiltonian and the bosonic operators are replaced with $\Tilde{a}_i^\dagger$ and $\Tilde{a}_i$ the action defined by Equations \ref{eq:bosonic-ops-altered}.
