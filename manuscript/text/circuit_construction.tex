...
For a toy pairing Hamiltonian $H = b_0^\dagger b_0 + b_0^\dagger b_1 + b_1^\dagger b_0 + b_1^\dagger b_1$, an example of the two oracles is: 
\begin{figure}[h]
    \includegraphics[width = 0.7\linewidth]{figures/pairing_ex.png}
    \caption{\textit{Select} unitary to block encode $b_1^\dagger b_0$ for the toy pairing Hamiltonian}
\end{figure}

\begin{figure}[h]
    \includegraphics[width = 0.7\linewidth]{figures/pairing_Oh.png}
    \caption{\textit{Coefficient} oracle unitary to encode coefficient of $b_1^\dagger b_0$ for the toy pairing Hamiltonian}
\end{figure}
\gus{We probably should put these side-by-side but I'm dogshit at figure formatting in Latex}
